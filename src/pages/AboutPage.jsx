        ...
        <div className="about-box">
          <div className="about-text-container">
            ...
            <p>
              ...
              specializes in <span className="gray-text">UI/UX Design</span>.
              With his knowledge in various frontend and backend technologies,
              he can make your dream website or application come to life with
              100% customization. He is open to collaboration and for more
              details, please fill out the contact form{" "}
              <span>
                <Link to="/contact" className="blue-text here">
                  here
                </Link>
              </span>
              .
